<x-layout :sharedData="$sharedData">
    <div class="container py-md-5 container--narrow">
        <h2>
          ...
          <a href="/profile-upload" class="btn btn-dark btn-sm">Change profile pic <i class="fas fa-image"></i></a>
          @endif
        ...
        <div class="profile-nav nav nav-tabs pt-2 mb-4">
          ...
          <a href="/profile/{{$sharedData['username']}}/follower" class="profile-nav-link nav-item nav-link">Followers: 3</a>
