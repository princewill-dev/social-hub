...
<html lang="en">
  ...
  <body>
            ...
            <form action="/login" method="POST" class="mb-0 pt-2 pt-md-0">
              ...
              <div class="row align-items-center">
                <div class="col-md mr-0 pr-md-0 mb-3 mb-md-0">
                  <input name="userlogin" class="form-control form-control-sm input-dark" type="text" placeholder="Username" autocomplete="off" />
                </div>
                <div class="col-md mr-0 pr-md-0 mb-3 mb-md-0">
    ...
    <center>
      ...
      <span class="mb-2 alert alert-success shadow-sm">{{session('success')}}</span>
      @endif

      @if (session()->has('faliure'))
      <span class="mb-2 alert alert-danger shadow-sm">{{session('faliure')}}</span>
      @endif
    </center>
    ...
    <footer class="border-top text-center small text-muted py-3">
        <p class="m-0">Copyright &copy; 2023 <a href="/" class="text-muted">NaijaPals</a>. All rights reserved.</p>
      </footer>
